...
class Files extends File
{
    ...
    private mixed $parent_dir = false;
    ...
    {
        $saved_path = Storage::disk('local')->putFileAs('public/' . $this->parent_dir, $this, $this->getSavePath());
        ...
        return (new TmpFile())->create(
            [
                ...
                'name'         => str_replace('.csv', '', $this->getOriginalName()),
            ]
        );
    }
}
